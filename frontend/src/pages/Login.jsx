...
export default function Login() {
    ...
    const submit = (e) => {
        e.preventDefault();
        toast.success("Welcome back, Guardian", { description: "Demo build — authentication is mocked for the hackathon." });
                    ...
                    <form onSubmit={submit} className="mt-8 space-y-5">
                        <div>
                            ...
                            <input
                                ...
                                className="mt-2 w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3.5 text-sm text-slate-100 placeholder:text-slate-600 focus:outline-none focus:border-neon/60 focus:shadow-[0_0_16px_rgba(0,240,255,0.15)] transition-[border-color,box-shadow] duration-300"
