        ...
        >
            <nav className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-3">
                    ...
                    <Link
                        to="/signup"
                        className="group inline-flex items-center gap-2 rounded-full border border-neon text-neon text-sm px-5 py-2.5 hover:bg-neon hover:text-black hover:shadow-[0_0_20px_rgba(0,240,255,0.6)] transition-colors duration-300"
