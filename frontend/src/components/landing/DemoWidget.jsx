...
const TIER_HEX = { CRITICAL: "#FF3366", WATCH: "#FFD600", STABLE: "#00F0FF" };
                    ...
                    <Reveal className="lg:col-span-4">
                        <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 h-full">
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                dept === d.id
                                                    ? "border-neon bg-neon/10 shadow-[0_0_16px_rgba(0,240,255,0.25)]"
                            ...
                            <button
                                ...
                                className="mt-8 w-full inline-flex items-center justify-center gap-2.5 rounded-full bg-neon text-black font-semibold px-6 py-3.5 hover:shadow-[0_0_26px_rgba(0,240,255,0.7)] transition-shadow duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
