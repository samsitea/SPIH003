            ...
            <div className="mt-4 lg:mt-0 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5" data-testid="agent-nodes">
                {AGENTS.map((a, i) => (
                    <Reveal key={a.n} delay={0.1 + i * 0.1}>
                        <div
                            className="group relative bg-slate-900/50 border border-white/10 rounded-2xl p-6 h-full hover:-translate-y-1.5 hover:border-neon/50 hover:shadow-[0_0_24px_rgba(0,240,255,0.15)] transition-[transform,border-color,box-shadow] duration-300"
